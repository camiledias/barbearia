                ...
                <ol>
                    ...
                    <li>Selecione o seu serviço <br />
                        <select name="selectServico" class="input">
                            <?php
                            //PASSO 1: incluir o arquivo da configuração da BDA
                            include "conexao_bd.php";
                            //PASSO 2 : Criar o comando de busca dos serviços
                            $sql = "SELECT * FROM servico ORDER BY descricao";
                            //PASSO 3: Executare trazer os resultados 
                            $resultado = retornarDados($sql);   
                            //PASSO 4:  Capturar cada linha de dados e adicionar uma option (ITEM) da select
